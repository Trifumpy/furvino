...
export default function AboutPage() {
  return (
    <Stack spacing={2}>
      ...
      <Box mt={4} />
      <Typography>
        If you have any questions, suggestions, want to keep up on site updates or want to be part of our community, join our Discord server!: <br />
        Discord server: 
        {" "}
      ...
      <Typography>
        ...
        Email:
        {" "}
        <Link href="mailto:team@furvino.com" target="_blank" rel="noopener">team@furvino.com</Link>
      </Typography>
      <Box mt={4} />
      <Divider sx={{ my: 3 }} />
      <Box mt={4} />
